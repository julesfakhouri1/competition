...
const Header = () => (
    <section className="text-center my-8 relative">
      ...
      <span className="relative inline-block">
        ...
        Devenez un <span className="relative z-20">tr&eacute;sor inestimable</span> pour les adultes de demain
      </span>
        </h1>
        ...
        <div className="flex justify-center items-center mt-8">
            <div className="w-1/2">
                ...
                <Link href="/download" passHref>
                    <button className="mt-4 bg-purple-700 text-white px-4 py-2 rounded">T&eacute;l&eacute;charger l&apos;app</button>
                </Link>
            </div>
        </div>
    </section>
