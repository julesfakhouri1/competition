...
const Profil = ({mobileNav, setMobileNav, handleMobileNav}:MobileNavProps) => {
    ...
    <div className="w-full h-full flex flex-col justify-start items-center pb-[20px] ">
        <header className="h-[64px] flex items-start justify-between w-[90%] mx-auto">
            <p className="playfair-display-font font-bold leading-[39.99px] w-[119px] mt-[12px] h-[40px] flex items-center text-[#513675] text-[30px]">
            Profil
            </p>
        ...
        <div className="w-full mt-0  mx-auto h-[500px] flex flex-col items-center justify-start  overflow-y-auto  ">
